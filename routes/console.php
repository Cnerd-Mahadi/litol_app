...
use App\Http\Services\FirebaseServices;
...
Artisan::command('send-welcome-mail', function () {
    $fire = new FirebaseServices();
    $data = $fire->getDocument('05935e0e9612469398a1', 'users');

    Mail::to('mahadidroid@gmail.com')->send(new ConfirmationMail($data));
